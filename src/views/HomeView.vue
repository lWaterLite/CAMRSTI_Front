			...
			<el-tab-pane v-for="tab in tabsList" :closable="tab.closable" :key="tab.name" :name="tab.name"
              ...
              <template>
                <el-popover trigger="hover" placement="top">
                  <el-image style="height: 200px" :src="pageLink+'api/request/img/'+tab.metalPhaseData.sfFullImg" fit="contain">
                    <div class="image-slot">
                      <i class="el-icon-picture-outline"/>
                    </div>
                  </el-image>
                  <div class="name-wrapper" slot="reference">
                    <a :href="pageLink+'api/request/img/'+tab.metalPhaseData.sfFullImg" target="_blank"
                       style="text-decoration: none; color: #409EAF">{{tab.metalPhaseData.sfFullImg}}</a>
                  </div>
                </el-popover>
              </template>
            </el-descriptions-item>
						<el-descriptions-item label="样品全图描述">{{tab.metalPhaseData.sfDescription}}</el-descriptions-item>
              ...
              <template>
                <el-popover trigger="hover" placement="top">
                  <el-image style="height: 200px" :src="pageLink+'api/request/img/'+tab.minePhaseData.mpFullImg" fit="contain">
                    <div class="image-slot">
                      <i class="el-icon-picture-outline"/>
                    </div>
                  </el-image>
                  <div class="name-wrapper" slot="reference">
                    <a :href="pageLink+'api/request/img/'+tab.minePhaseData.mpFullImg" target="_blank"
              ...
              <template>
                <el-popover trigger="hover" placement="top">
                  <el-image style="height: 200px" :src="pageLink+'api/request/img/'+tab.emPhaseData.emFullImg" fit="contain">
                    <div class="image-slot">
                      <i class="el-icon-picture-outline"/>
                    </div>
                  </el-image>
                  <div class="name-wrapper" slot="reference">
                    <a :href="pageLink+'api/request/img/'+tab.emPhaseData.emFullImg" target="_blank"
                       style="text-decoration: none; color: #409EAF">{{tab.emPhaseData.emFullImg}}</a>
                  </div>
                </el-popover>
              </template>
            </el-descriptions-item>
						<el-descriptions-item label="样品全图描述">{{tab.emPhaseData.emDescription}}</el-descriptions-item>
