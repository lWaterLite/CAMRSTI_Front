							...
							<el-row>
								<el-col :span="24">
									<el-tabs type="card" @tab-click="handleClick">
										<el-tab-pane label="金相" name="first">
											<el-table  border height="40vh" style="width: 100%">
												<el-table-column  prop="metalPhase" label="有/无" width="80"></el-table-column>
												<el-table-column  prop="sampleFullImg" label="样品全图" width="260"></el-table-column>
												<el-table-column  prop="mpDescription" label="样品描述" width="190"></el-table-column>
												<el-table-column  prop="mpEquipment" label="设备" width="120"></el-table-column>
												<el-table-column  prop="mpZoom" label="放大倍数" width="120"></el-table-column>
												<el-table-column  prop="mpPhotoMod" label="拍摄模式" width="120"></el-table-column>
												<el-table-column  prop="mpImage" label="金相照片" width="260"></el-table-column>
												<el-table-column  prop="mpImageDescription" label="金相描述" width="190"></el-table-column>
											</el-table>
										</el-tab-pane>
										<el-tab-pane label="矿相" name="second">
											<span>{{ props.row.test }}</span>
										</el-tab-pane>
										<el-tab-pane label="电子显微" name="third">
											<span>{{ props.row.test }}</span>
										</el-tab-pane>
